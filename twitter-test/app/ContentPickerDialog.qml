...
//Component {
    Popups.PopupBase {
        ...
        Component.onCompleted: {
          if(typeof acceptTypes === 'undefined' || variable === null){
            console.log("[DEBUG]  CPD accessTypes undefined ");
            peerPicker.contentType = ContentType.All
          }
          else{
            if(acceptTypes.length === 1) {
              console.log("[DEBUG]  CPD accessTypes ");
                ...
                console.log("[DEBUG]  CPD accessTypes not 1 ");
                peerPicker.contentType = ContentType.All
            }
          }
            show()
